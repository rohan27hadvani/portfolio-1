                  ...
                  <>
                    ...
                    tablet:h-full tablet:w-full`}> 
                      <div className='text-black font-gilroy font-light px-6'>
                        ...
                        mobile:mt-10 mobile:pb-[50px] tablet:mt-2
                        
                        laptop:text-[17px] laptop:mt-3 desktop:text-[19px] screen14:m-0 screen14:text-[22px] screen16:text-[24px] screen16:mt-2 tablet:text-[12px]'>
                    ...
                    mobile:mt-4 tablet:mt-0 `}>
                      <div className='text-black font-gilroy w-full h-full'>
                        ...
                        mobile:mt-[60px] tablet:text-3xl tablet:mt-4 laptop:text-5xl'>
                          Contact me
                        </div>
                      </div>
                    </div>
